                ...
                <div class="p-6 text-gray-900">
                    <div>
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center space-x-8">
                                ...
                                <div class="flex space-x-4">
                                    <input wire:model.live="searchQuery" type="search" id="search" placeholder="Search..."
                                           class="px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300">

                                    <select wire:model.live="searchCategory" name="category" class="px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300">
                                ...
                                <div>
                                    <a href="{{ route('areas.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 rounded-md font-semibold text-xs text-white uppercase tracking-widest">
                                        Add new area
                                    </a>
                                </div>
                            </div>
                            ...
                            {{--    Use wire.loading and wire:target for the element to only appear on certain click events--}}
                            <div wire:loading wire:target="deleteArea">
                                Removing area...
                            </div>

                            <div class="min-w-full align-middle" wire:loading.delay.class="opacity-50">
